...
covDir2 <- "/projects/ajt200/BAM_masters/SPO11-oligo/WT/coverage/"
...
covDir6 <- "/projects/ajt200/BAM_masters/nucleosomes/coverage/"
...
inNames <- c("REC8_log2ChIPinput", "WT_H3K4me3_log2ChIPinput", "WT_H3K9me2_log2ChIPinput", "MSH4_log2ChIPinput")
inNames2 <- c("WT_SPO11-oligo_RPI1")
...
inNames6 <- c("WT_nuc")
libNames <- c("REC8", "H3K4me3", "H3K9me2", "MSH4")
libNames2 <- c("SPO11-1-oligos (untransformed)")
libNames3 <- c("SPO11-1 ChIP")
libNames4 <- c("H2A", "H2A.W", "H2A.X", "H2A.Z")
libNames5 <- c("RNA-seq")
libNames6 <- c("MNase (untransformed)")
libNamesCombined <- c("REC8", "H3K4me3", "H3K9me2", "MSH4", "SPO11-1-oligos (untransformed)", "SPO11-1 ChIP", "H2A", "H2A.W", "H2A.X", "H2A.Z", "RNA-seq", "MNase (untransformed)")
...
dat6 <- lapply(seq_along(inNames6), function(x) {
  read.table(file = paste0(covDir6, inNames6[x], "_norm_allchrs_coverage_coord_tab_11300000.bed"))
})
